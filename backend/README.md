...
## Project Structure
    ...
    ├── tautuk_logistics_po_36928  # Django project configurations
...
1. Clone this repo and `cd tautuk_logistics_po_36928`
...
2. Clone this repo and `cd tautuk_logistics_po_36928`
